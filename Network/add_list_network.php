...
<table width="1200" border="0" align="center" cellpadding="4" cellspacing="0">
    ...
    $pageRow_records = 10;
			...
			echo "<p align='center'>";
			echo "<form align='center' action='add_list_network.php'  method='post'>";
			...
			if ($num_pages > 1) 
			{   
				echo "<a href='add_list_network.php?page=1'>第一頁</a>";
				echo "|";
				echo "<a href='add_list_network.php?page=".$num1."'>上一頁</a>";
				echo "|"; 
			}
			if ( $num_pages < $total_pages ) 
			{
				echo "<a href='add_list_network.php?page=".$num2."'>下一頁</a>";
				echo "|";
				echo "<a href='add_list_network.php?page=".$total_pages."'>最末頁</a>";
			}
...
<div class="regbox">
			...
			<li class='function'><a href='add_list_network.php'>IP資料清單</a></li>
						
            <li class='function'><a href='network.php'>阻斷資料清單</a></li>
			<li class='function'><a href='network.php?process=not_process'>待處理資料</a></li>
			<li class='function'><a href='network.php?process=complete'>待開通資料</a></li>
			<li class='function'><a href='network.php?process=history'>歷史資料</a></li>
			<li class='function'><a href='network.php?logout=true'>登出</a></li>
